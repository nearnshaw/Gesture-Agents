...
from .shadow import shadowCursorOnPad
...
class RecognizerCursorOnPad(Recognizer):
    ...
    def RemovePad(self, Figure):
        ...
        print "cursor killed by pad gone!!"
    ...
    def EventRemoveCursor(self, Cursor):
        ...
        print "cursor on pad termina ahora"
        self.finish()
    ...
    def relPos(self):
        ...
        ###### crPoscm = CRelPos(self.cPos[0], self.cPos[1], self.pxcm, self.pycm, self.pzcm, self.yaw, self.pitch, self.roll)
        ...
        result = ( self.cPos[0] - self.px , 300 - (self.cPos[1] - self.py) )
        return result
